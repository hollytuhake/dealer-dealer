...
router.get('/', function (req, res) {
    ...
    pool.connect(function (errorConnectingtoDB, db, done) {
        if (errorConnectingtoDB) {
            ...
            var queryText = 'SELECT "orders".*, array_agg("order_products"."quantity") as "quantities", array_agg("products"."name") as "productNames" FROM "orders" JOIN "order_products" ON "orders"."id" = "order_products"."order_id" JOIN "products" ON "order_products"."product_id" = "products"."id" GROUP BY "orders"."id" ORDER BY "orders"."id" DESC;';
